...
window.Omnibug = (() => {
    ...
    d.getElementById("export-form").addEventListener("submit", (event) => {
        ...
        // Add any headers
        exportText = `"` + ["Omnibug_SLS v2.1.0", "Exported " + (new Date()).toString()].join(colDelim) + `"\n`
    ...
    function buildRequest(request) {
        ...
        let redirectHelpLink = createElement("a", {
                "attributes": {
                    "target": "_blank",
                    "href": "https://omnibug.io/help/redirected-requests?utm_source=omnibug&utm_medium=chrome&utm_campaign=redirect-help-warning"
                },
                "text": "Learn more."
            }),
        ...
        if(request.request.postError) {
            const warningIcon = createElement("i", {
                ...
                "attributes": {
                    "target": "_blank",
                    "href": "https://omnibug.io/help/post-data-error?utm_source=omnibug&utm_medium=chrome&utm_campaign=post-data-warning"
                },
                "text": "Learn more."
            }),
